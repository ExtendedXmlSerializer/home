	...
	public sealed class Issue148Tests
	{
		...
		public void Verify()
		{
			...
			serializer.Assert(subject,
			                  @"<?xml version=""1.0"" encoding=""utf-8""?><ConfiguredSubject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Message>Hello World!</Message></ConfiguredSubject>")
		...
		public void VerifyComposite()
		{
			...
			var subject = new Subject {Message = "Hello World!"};
			serializer.Assert(subject,
			                  @"<?xml version=""1.0"" encoding=""utf-8""?><ConfiguredSubject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues"" />")
			          .Message.Should()
			          .BeNull();
		}
