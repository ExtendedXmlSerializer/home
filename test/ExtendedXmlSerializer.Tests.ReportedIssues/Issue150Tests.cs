...
namespace ExtendedXmlSerializer.Tests.ReportedIssues
{
	public sealed class Issue150Tests
	{
		...
		public void Verify()
		{
			...
			serialize.Should()
			         .Be(@"<?xml version=""1.0"" encoding=""utf-8""?><Issue150Tests-Subject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Message>Hello World!</Message></Issue150Tests-Subject>");
		...
		public void VerifyActivatedDependency()
		{
			var serializer = new ConfigurationContainer().Type<Subject>()
			                                             ...
			                                             .Register()
			                                             .Serializer()
			                                             .Of<ActivatedSerializer>()
			                                             .Create()
			                                             .ForTesting();

			var serialize = serializer.Serialize(new Subject {Message = "Hello???"});
			serialize.Should()
			         .Be(@"<?xml version=""1.0"" encoding=""utf-8""?><Issue150Tests-Subject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Message><string xmlns=""https://extendedxmlserializer.github.io/system"">Hello world! Hello???</string></Message></Issue150Tests-Subject>");
		...
		public void VerifyVerbatim()
		{
			...
			serialize.Should()
			         .Be(@"<?xml version=""1.0"" encoding=""utf-8""?><Issue150Tests-Subject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Message><![CDATA[Hello??? (<, &, ', and "")]]></Message></Issue150Tests-Subject>");
		...
		public void VerifyVerbatimAttribute()
		{
			...
			var serialize = serializer.Serialize(subject);
			serialize.Should()
			         .Be(@"<?xml version=""1.0"" encoding=""utf-8""?><Issue150Tests-SubjectWithAttribute xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Message><![CDATA[Hello??? (<, &, ', and "")]]></Message></Issue150Tests-SubjectWithAttribute>");
