...
namespace ExtendedXmlSerializer.Tests.ReportedIssues
{
	public sealed class Issue154Tests
	{
		...
		public void VerifyActivation()
		{
			...
			var data =
				@"<?xml version=""1.0"" encoding=""utf-8""?><Issue154Tests-Subject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues"">Custom String!</Issue154Tests-Subject>";
