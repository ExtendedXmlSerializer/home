	...
	public sealed class Issue167Tests
	{
		...
		public void VerifyContent()
		{
			...
			container.Assert(new Subject {Message = message},
			                 @"<?xml version=""1.0"" encoding=""utf-8""?><Issue167Tests-Subject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Message><![CDATA[]]></Message></Issue167Tests-Subject>");
		}
