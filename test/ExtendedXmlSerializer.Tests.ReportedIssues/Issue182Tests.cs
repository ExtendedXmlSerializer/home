	...
	public sealed class Issue182Tests
	{
		...
		void Verify()
		{
			...
			serializer.Assert(new Leistungszeitraum {Monat = "Hallo Welt", Typ = Leistungszeitraum.LeistungszeitraumTyp.Monat},
			                  @"<?xml version=""1.0"" encoding=""utf-8""?><Issue182Tests-Leistungszeitraum Typ=""Monat"" xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Monat>Hallo Welt</Monat></Issue182Tests-Leistungszeitraum>");
			...
			serializer.Assert(new Leistungszeitraum {Tag = new DateTime(2018, 5, 18), Typ = Leistungszeitraum.LeistungszeitraumTyp.Tag},
			                  @"<?xml version=""1.0"" encoding=""utf-8""?><Issue182Tests-Leistungszeitraum Typ=""Tag"" xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Tag>2018-05-18T00:00:00</Tag></Issue182Tests-Leistungszeitraum>");
