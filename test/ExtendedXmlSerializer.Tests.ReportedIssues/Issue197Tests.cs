	...
	public sealed class Issue197Tests
	{
		...
		void VerifyIgnore()
		{
			new ConfigurationContainer().Extend(FallbackSerializationExtension.Default)
			                            ...
			                            .ForTesting()
			                            .Assert(new Button(),
			                                    @"<?xml version=""1.0"" encoding=""utf-8""?><Issue197Tests-Button xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><DialogResult>None</DialogResult></Issue197Tests-Button>");
			new ConfigurationContainer().Extend(FallbackSerializationExtension.Default)
			                            .Type<Button>()
			                            .Create()
			                            .ForTesting()
			                            .Assert(new Button(),
			                                    @"<?xml version=""1.0"" encoding=""utf-8""?><Issue197Tests-Button xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><AutoSize>false</AutoSize><DialogResult>None</DialogResult></Issue197Tests-Button>");
		}
