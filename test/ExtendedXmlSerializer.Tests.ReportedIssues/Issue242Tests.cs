	...
	public sealed class Issue242Tests
	{
		...
		void Verify()
		{
			...
			new ConfigurationContainer().Type<Subject>()
			                            ...
			                            .ForTesting()
			                            .Assert(instance,
			                                    @"<?xml version=""1.0"" encoding=""utf-8""?><Issue242Tests-Subject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests.ReportedIssues""><Value>2019-03-05</Value></Issue242Tests-Subject>");
		}
