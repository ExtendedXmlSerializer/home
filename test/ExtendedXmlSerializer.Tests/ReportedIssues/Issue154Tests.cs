...
namespace ExtendedXmlSerializer.Tests.ReportedIssues
{
	public sealed class Issue154Tests
    {
	    ...
	    public void VerifyActivation()
	    {
		    ...
		    var data = @"<?xml version=""1.0"" encoding=""utf-8""?><Issue154Tests-Subject xmlns=""clr-namespace:ExtendedXmlSerializer.Tests.ReportedIssues;assembly=ExtendedXmlSerializer.Tests"">Custom String!</Issue154Tests-Subject>";
		...
		sealed class SerializerWithDependencies : IExtendedXmlCustomSerializer<Subject>
		{
			...
			public Subject Deserialize(XElement xElement) => new Subject{ Message = (string) _serializers.Get(typeof(string)).Deserialize(xElement) };

			public void Serializer(XmlWriter xmlWriter, Subject obj)
			{
				_serializers.Get(typeof(string)).Serializer(xmlWriter, obj.Message);
			}
		}
