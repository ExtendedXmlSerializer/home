...
namespace ExtendedXmlSerialization.Test.Support
{
	class ServicesSupport : IServices
	{
		...
		public IServices Register<TService>(Func<IServiceProvider, TService> factory) => _services.Register(factory);

		public IServices Register<T, TService>(Func<IServiceProvider, T, TService> factory) => _services.Register(factory);

		public IServices Register<T, TService>(Func<IServiceProvider, T, TService> factory, string serviceName) => _services.Register(factory, serviceName);

		public IServices Register<T1, T2, TService>(Func<IServiceProvider, T1, T2, TService> factory) => _services.Register(factory);

		public IServices Register<T1, T2, TService>(Func<IServiceProvider, T1, T2, TService> factory, string serviceName) => _services.Register(factory, serviceName);

		public IServices Register<T1, T2, T3, TService>(Func<IServiceProvider, T1, T2, T3, TService> factory) => _services.Register(factory);

		public IServices Register<T1, T2, T3, TService>(Func<IServiceProvider, T1, T2, T3, TService> factory, string serviceName) => _services.Register(factory, serviceName);

		public IServices Register<T1, T2, T3, T4, TService>(Func<IServiceProvider, T1, T2, T3, T4, TService> factory) => _services.Register(factory);

		public IServices Register<T1, T2, T3, T4, TService>(Func<IServiceProvider, T1, T2, T3, T4, TService> factory, string serviceName) => _services.Register(factory, serviceName);

		public IServices Register<TService>(Func<IServiceProvider, TService> factory, string serviceName) => _services.Register(factory, serviceName);
		...
		public IServices RegisterConstructorDependency<TDependency>(Func<IServiceProvider, ParameterInfo, TDependency> factory) => _services.RegisterConstructorDependency(factory);

		public IServices RegisterConstructorDependency<TDependency>(Func<IServiceProvider, ParameterInfo, object[], TDependency> factory) => _services.RegisterConstructorDependency(factory);
		...
		public IServices Decorate<TService>(Func<IServiceProvider, TService, TService> factory) => _services.Decorate(factory);
	}
}